...
class AlexNet224(nn.Module):
    def __init__(self,num_classes = 1000):
        ...
        self.ConvBlock1 = nn.Sequential(
            nn.Conv2d(in_channels=3 , out_channels=96 , kernel_size=(11,11) , padding=1 , stride=4),
            nn.LeakyReLU(0.1),
        ...
        self.ConvBlock2 = nn.Sequential(
            nn.Conv2d(in_channels=96 , out_channels=256 , kernel_size=(7,7) , padding=3 , stride=1),
            nn.LeakyReLU(0.1),
            nn.MaxPool2d(kernel_size=(3,3)  ,stride=2),
            nn.BatchNorm2d(256)
        )
