...
class VGGNet19(nn.Module):
    def __init__(self, in_channels =3 , num_classes = 10):
        ...
        self.ConvBlock4a = self._create_block(in_channels=256 , out_channels=256)
        self.ConvBlock4b = self._create_block(in_channels=256 , out_channels=256 , pool=True)
        ...
        self.ConvBlock6a = self._create_block(in_channels=512 , out_channels=512)
        self.ConvBlock6b = self._create_block(in_channels=512 , out_channels=512 ,pool=True)
        ...
        self.ConvBlock7b = self._create_block(in_channels=512 , out_channels=512 )
